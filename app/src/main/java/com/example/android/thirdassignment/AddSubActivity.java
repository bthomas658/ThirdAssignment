package com.example.android.thirdassignment;
...
/*
  ...
  Bill Thomas 10/14/15
 */

public class AddSubActivity extends ActionBarActivity implements View.OnClickListener{
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        //call the other activity pass over the counter vaule
